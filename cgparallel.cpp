...
double* Conjugate_gradient(int n ,int rowptac[] ,int colac[] ,double valac[] ,double b[])
   {  const int size=n;
...
{ 
	...
	MPI_Init(&argc,&argv);
	 ...
	 /*pr- no of processors
	 r: rank
	 lp:no of processors inside each communicator
	 lr:new rank inside the sub communicator
	 color and key: used for MPI_Comm_split
	 */
...
//Displaying the matrix B
  ...
  // Conjugate gradient solver
	 Conjugate_gradient(nsquare,rowptac,colac,valac,b);
